...
public class MapLocationActivity extends FragmentActivity implements OnMapReadyCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //1;16minutos de la clase 14-12-2023
        getLocation();
    }
    private void getLocation(){
        //se valida que los permisos de ubicacion esten activos
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        MarkerOptions marker= new MarkerOptions().position(latLng).title("Aqui estoy");
